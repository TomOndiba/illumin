			...
			jQuery(function($){
				...
				$(document).on("scroll", function() {
					if ($(document).scrollTop() > 50) {
						...
						$(".hidden").addClass("shrink");
						$("#header-search").addClass("shrink");
						$("#illumin-logo-small").addClass("shrink");
						//$("#header-search").css("display", "none");
						$("#header-search").addClass("shrink");
						console.log("shrink");
					}
					else {
						$(".fusion-header").removeClass("shrink");
						$(".hidden").removeClass("shrink");
						$("#header-search").removeClass("shrink");
						$("#illumin-logo-small").removeClass("shrink");
